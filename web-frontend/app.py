...
def lambda_handler(event, context):
    try:
        ...
        # Simple HTML page that displays NHL stats - using string concatenation to avoid f-string issues
        html_content = """
<!DOCTYPE html>
<html>
<head>
...
"""
        ...
        logger.error("Error in web frontend Lambda: " + str(e))
        return {
            'statusCode': 500,
            'headers': {
                'Content-Type': 'text/html; charset=utf-8',
            },
            'body': '<html><body><h1>Error</h1><p>Internal server error: ' + str(e) + '</p></body></html>'
        }